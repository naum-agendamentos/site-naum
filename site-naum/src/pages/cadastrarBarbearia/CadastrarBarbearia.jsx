    ...
    const handleSave = () => {
        if (validateFields()) {
            ...
            api.request(options).then(response => {
                ...
                toast.success("Nova barbearia adicionada com sucesso!");
                    ...
                    <div className={styles["container-adicionar"]}>
                        <div className={styles["secao-esquerda-adicionar"]}>
                            ...
                            <form>
                                <input
                                    type="text"
                                    className={styles[inputValidNomeBarb]}
                                    onInput={inputSomenteTexto}
                                    value={nome}
                                    onBlur={handleNomeBarbBlur}
                                    placeholder="Nome da Barbearia"
                                    onChange={(e) => handleInputChange(e, setNome)}
                                />
                                <input
                                    type="text"
                                    className={styles[inputValidLink]}
                                    value={linkBarbearia}
                                    onBlur={handleLinkBlur}
                                    placeholder="Link da Barbearia"
                                    onChange={(e) => handleInputChange(e, setLinkBarbearia)}
                                />
                                <input
                                    type="text"
                                    className={styles[inputValidCep]}
                                    maxLength={8}
                                    id="IptCep"
                                    value={cep}
                                ...
                                <input
                                    type="text"
                                    className={styles[inputValidRua]}
                                    value={rua}
                                ...
                                <input
                                    type="text"
                                    className={styles[inputValidCidade]}
                                    value={cidade}
                                ...
                                <input
                                    type="text"
                                    className={styles[inputValidBairro]}
                                    value={bairro}
                                ...
                                <div className={styles["inputs-junto"]}>
                                    <input
                                        type="text"
                                        className={styles[inputValidNumero]}
                                        value={numero}
